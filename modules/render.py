...
def _gpu_bin_splats_to_tiles(x0, x1, y0, y1, B:int, N:int, H:int, W:int, tile:int):
    ...
    tile_local = ty * nTX + tx
    tile_global = b_exp * ntiles + tile_local
    ...
    # Per-tile counts and offsets for all B * ntiles
...
def _render_tile_over_kernel(
    C_ptr, H, W, stride_b, stride_h, stride_w,
...
def render_splats_rgb_triton(
    ...
    # GPU binning of splats to tiles
